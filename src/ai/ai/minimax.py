...
def get_best_move(state, max_player_color, min_player_color, current_player_color, depth, utility_function):
    ...
    for move in get_available_moves(state, current_player_color):
        ...
        if current_player_color == max_player_color:
            eval = minimax(new_state, depth, alpha, beta, maximizing_player = False, max_player_color = max_player_color, min_player_color = min_player_color, utility_function = utility_function)
            print("move max player: ", move, eval, current_player_color, max_player_color, min_player_color)
            best_moves.append((move, eval))
                
        else:
            eval = minimax(new_state, depth, alpha, beta, maximizing_player = True, max_player_color = max_player_color, min_player_color = min_player_color, utility_function = utility_function)
